...
*64)
    ...
    winstall-mpg123 "${TARGET_PLATFORM}" http://mpg123.de/download/win64/1.25.13/mpg123-1.25.13-x86-64.zip 809e847de9169e63b65d1593d163977c2fca5a65
    ;;
*in32|*86)
    ...
    winstall-mpg123 "${TARGET_PLATFORM}" http://mpg123.de/download/win32/1.25.13/mpg123-1.25.13-x86.zip 4af3c0e278dab84e9d2c503c30a0517aa5d40205
    ;;
*)

...
*64)
    winstall-exe https://sourceforge.net/projects/boost/files/boost-binaries/1.74.0/boost_1_74_0-msvc-14.1-64.exe 367523cbd3fb260e1a2aee2f6d54367a4139deae /VERYSILENT
    ...
    ;;
*in32|*86)
    winstall-exe https://sourceforge.net/projects/boost/files/boost-binaries/1.74.0/boost_1_74_0-msvc-14.1-32.exe 98d4e27b7983827a83b193bb5888a900aed3fc57 /VERYSILENT

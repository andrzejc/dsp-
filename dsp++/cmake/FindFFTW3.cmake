...
#	message("PC_FFTW3F: ${PC_FFTW3F_LIBDIR}")

	find_library(FFTW3F_LIBRARY NAMES fftw3f libfftw3f HINTS ${PC_FFTW3F_LIBDIR} ${PC_FFTW3F_LIBRARY_DIRS} )
	find_library(FFTW3F_THREADS_LIBRARY NAMES fftw3f_threads libfftw3f_threads HINTS ${PC_FFTW3F_LIBDIR} ${PC_FFTW3F_LIBRARY_DIRS} )
...
#	message("FFTW3F_LIBRARY: ${FFTW3F_LIBRARY}")
	...
	find_library(FFTW3D_LIBRARY NAMES fftw3 libfftw3 HINTS ${PC_FFTW3D_LIBDIR} ${PC_FFTW3D_LIBRARY_DIRS} )
	find_library(FFTW3D_THREADS_LIBRARY NAMES fftw3_threads libfftw3_threads HINTS ${PC_FFTW3D_LIBDIR} ${PC_FFTW3D_LIBRARY_DIRS} )
	...
	find_library(FFTW3L_LIBRARY NAMES fftw3l libfftw3l HINTS ${PC_FFTW3L_LIBDIR} ${PC_FFTW3L_LIBRARY_DIRS} )
	find_library(FFTW3L_THREADS_LIBRARY NAMES fftw3l_threads libfftw3l_threads HINTS ${PC_FFTW3L_LIBDIR} ${PC_FFTW3L_LIBRARY_DIRS} )
